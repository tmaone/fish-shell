                                    ...
                                    std::set<file_id_t> &visited_files)
{
    ...
    if (! segment_has_wildcards && ! is_last_segment)
    {
        ...
        /* Early out! */
        return wildcard_expand_internal(new_wc, new_base_dir.c_str(), cwd, flags, out, completion_set, visited_files);
    }
    ...
    const wcstring dir_string = (base_dir[0] == L'\0') ? L"." : base_dir;
